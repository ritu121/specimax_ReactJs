...
export default function TaskManagement() {
  ...
  const getTasks = async (sId = null, sDate = null, eDate = null) => {
    ...
    let data = await getAPI('/visitor/list' + url)
    if (data) {
      setTasks(data)
    }
    setLoader(false)
      ...
      <Box ml={5}>
        ...
        >
          ...
          <Grid sx={{ my: "1rem", justifyContent: 'space-around', alignItems: 'center' }} container spacing={3} width={"100%"}>
            ...
            <Grid sx={{ padding: '8px !important', m: '10', borderRadius: '5px !important', boxShadow: ' 0px 2px 4px 3px rgba(0, 0, 0, 0.08)' }}>
             <PeopleAltIcon/> 71 Total Tasks
            </Grid>
            <Grid sx={{ padding: '8px !important', m: '10', borderRadius: '5px !important', boxShadow: '0px 2px 4px 3px rgba(0, 0, 0, 0.08)' }}>
            <PeopleAltIcon/> 53 Tasks Completed
            </Grid>
            <Grid sx={{ padding: '8px !important', m: '10', borderRadius: '5px !important', boxShadow: '0px 2px 4px 3px rgba(0, 0, 0, 0.08)' }}>
            <PeopleAltIcon/> 86 Reportable Issues
            </Grid>
            <Grid sx={{ padding: '8px !important', m: '10', borderRadius: '5px !important', boxShadow: '0px 2px 4px 3px rgba(0, 0, 0, 0.08)' }}>
            <PeopleAltIcon/> 9 Injuries Reported
            </Grid>
